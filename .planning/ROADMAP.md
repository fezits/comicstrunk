...
Plans:
- [ ] 03-01-PLAN.md — API gaps: atomic limit enforcement ($transaction), photo upload endpoint (Cloudinary), missing editions endpoint, structured plan limit errors (Wave 1)
- [ ] 03-02-PLAN.md — Frontend gaps: plan limit banner with upgrade CTA, missing editions panel on series progress, catalog quick-add button, photo upload UI on item detail (Wave 2)
